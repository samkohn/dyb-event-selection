...
parser.add_argument('--sublist', type=int, default=-1)
...
if args.lineno is not None:
    ...
    if current_index > max_index:
        try:
            ...
            subprocess.check_output(['touch', os.path.join(args.srcdir, 'progress/__possible_error_%d__' %
                current_index)])
        finally:
            print('echo done')
            sys.exit(0)
